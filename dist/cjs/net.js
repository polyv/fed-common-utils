...
exports.changeProtocol = exports.startsWithProtocol = void 0;
// 匹配开头的协议
var reProtocol = /^(?:([a-z]+):)?\/{2,3}/i;
/**
 ...
 * ```
 */
function startsWithProtocol(str, protocols) {
    var result = reProtocol.test(str);
    if (result && protocols) {
...
exports.changeProtocol = changeProtocol;
